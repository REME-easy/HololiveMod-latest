...
public class ShiroganeNoel extends AbstractMinion {
    private static final String ID = "Hololive_ShiroganeNoel";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/ShiroganeNoel.png";
    ...
    private static final int originalATK = 12;
    public ShiroganeNoel(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new ShiroganeNoel(this.upgraded);
    }
