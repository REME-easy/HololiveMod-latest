...
public class OzoraSubaru extends AbstractMinion {
    private static final String ID = "Hololive_OzoraSubaru";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/OzoraSubaru.png";
    ...
    public OzoraSubaru(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new OzoraSubaru(this.upgraded);
    }
