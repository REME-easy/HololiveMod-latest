...
public class NatsuiroMatsuri extends AbstractMinion {
    private static final String ID = "Hololive_NatsuiroMatsuri";
    ...
    public NatsuiroMatsuri(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new NatsuiroMatsuri(this.upgraded);
    }
    ...
    public void onDamaged(int dmg, boolean Effect){
        if(dmg != 0) {
            ...
            if(AbstractDungeon.player.hasRelic("Hololive_FriedShrimpLion")){
