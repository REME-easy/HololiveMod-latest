...
public class MoonaHoshinova extends AbstractMinion {
    private static final String ID = "Hololive_MoonaHoshinova";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/MoonaHoshinova.png";
    ...
    public MoonaHoshinova(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new MoonaHoshinova(this.upgraded);
    }
