...
import hololivemod.cards.summonCard.CallPigeonMan;
...
public class PigeonMan extends AbstractMinion {
    private static final String ID = "Hololive_PigeonMan";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/PigeonMan.png";
    ...
    public PigeonMan(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new PigeonMan(this.upgraded);
    }

    @Override
    public void onEvoke(){
            AbstractDungeon.actionManager.addToBottom(new MakeTempCardInHandAction(new CallPigeonMan()));
        super.onEvoke();
    }
