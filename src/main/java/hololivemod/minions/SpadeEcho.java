...
public class SpadeEcho extends AbstractMinion {
    private static final String ID = "Hololive_SpadeEcho";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/SpadeEcho.png";
    ...
    public SpadeEcho(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new SpadeEcho(this.upgraded);
    }
    ...
    public void AttackEffect(){
        ...
        AbstractDungeon.actionManager.addToBottom(new GainGoldAction(2));
        Trigger();
        super.AttackEffect();
    }
