...
public class ShishiroBotan extends AbstractMinion {
    private static final String ID = "Hololive_ShishiroBotan";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/ShishiroBotan.png";
    ...
    public ShishiroBotan(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new ShishiroBotan(this.upgraded);
    }
