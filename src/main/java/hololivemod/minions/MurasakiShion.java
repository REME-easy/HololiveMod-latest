...
import hololivemod.cards.summonCard.CallMurasakiShion;
...
public class MurasakiShion extends AbstractMinion {
    private static final String ID = "Hololive_MurasakiShion";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/MurasakiShion.png";
    ...
    public MurasakiShion(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new MurasakiShion(this.upgraded);
    }

    @Override
    public void onEvoke(){
        AbstractCard c = new CallMurasakiShion();
        if(upgraded)
            c.upgrade();
