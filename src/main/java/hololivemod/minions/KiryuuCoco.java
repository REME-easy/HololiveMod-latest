...
public class KiryuuCoco extends AbstractMinion {
    private static final String ID = "Hololive_KiryuuCoco";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/KiryuuCoco.png";
    private static final int basePassiveAmount = 10;
    private static final int baseEvokeAmount = 3;
    private static final int originalHP = 10;
    private static final int originalATK = 10;
    public KiryuuCoco(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new KiryuuCoco(this.upgraded);
    }
