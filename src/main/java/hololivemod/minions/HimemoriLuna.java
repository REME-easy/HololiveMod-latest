...
public class HimemoriLuna extends AbstractMinion {
    private static final String ID = "Hololive_HimemoriLuna";
    private static final OrbStrings cardStrings = CardCrawlGame.languagePack.getOrbString(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String[] DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String IMG_PATH = "img/Orbs/HimemoriLuna.png";
    private static final int basePassiveAmount = 3;
    private static final int baseEvokeAmount = 3;
    private static final int originalHP = 7;
    private static final int originalATK = 7;
    public HimemoriLuna(boolean upgraded){
    ...
    public AbstractMinion makeCopy(){
        return new HimemoriLuna(this.upgraded);
    }
