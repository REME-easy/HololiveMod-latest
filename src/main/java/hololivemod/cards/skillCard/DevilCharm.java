...
import hololivemod.cards.summonCard.CallTokoyamiTowa;
...
public class DevilCharm extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for(j = 0 ; j < akicount + 1 ; ++j) {
            if (akipluscount > 0) {
                this.addToBot(new SpawnMateAction(new TokoyamiTowa(false),CardHelper.isBalance?6:10,CardHelper.isBalance?6:10));
